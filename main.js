// (USER INPUT) input name here
var username = '';

// (USER INPUT) inputs question for the eightBall here
var userQuestion = 'Will I marry Tarzan?';

// if user doesn't input a name this appears
if (username === ''){
console.log(`Hello!`);
}
...
// (OUTPUT) if eightball is equal to 0, the console spits out this statement
if (eightBall === 0){
    console.log('It is certain , my dear!');
}

// (OUTPUT) if eightball is equal to 1, the console spits out this statement
else if (eightBall === 1){
    console.log('It is decidedly so!');
}

// (OUTPUT) if eightball is equal to 2, the console spits out this statement
else if (eightBall === 2){
    console.log('My head hurts! Reply hazy try again.');
}

// (OUTPUT) if eightball is equal to 3, the console spits out this statement
else if (randomNumber === 3){
    console.log('Off on lunch. Cannot predict now.');
}
    
// (OUTPUT) if eightball is equal to 4, the console spits out this statement

else if (randomNumber === 4){
    console.log('Do not count on it. ');
}

// (OUTPUT) if eightball is equal to 5, the console spits out this statement
else if (randomNumber === 5){
    console.log('My sources say no. Bummer.');
}

// (OUTPUT) if eightball is equal to 6, the console spits out this statement
else if (randomNumber === 6){
    console.log('Outlook not so good.');
}

// (OUTPUT) if eightball is equal to 7, the console spits out this statement
